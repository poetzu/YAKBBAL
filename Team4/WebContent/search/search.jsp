...
/*//탭  */
	...
	function pill() {
		var cycle = prompt("주기를 입력하세요. ( 10 ~ 100 사이)");
...
<!-- 본문내용 -->
	...
	<br><br><br>
 	...
 	<div class="container">
		...
		<div id="bottom">
		<div id="tab-1" class="tab-content current"  style="-ms-overflow-style: none;">
		
		</div>
	
		<div id="tab-2" class="tab-content" style="-ms-overflow-style: none;">
		
		</div>
		<div id="tab-3" class="tab-content" style="-ms-overflow-style: none;">
		</div>
		<div id="tab-4" class="tab-content"  style="-ms-overflow-style: none;">
		</div>
		</div>	<!-- bottom -->
